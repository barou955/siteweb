...
export default function TestimonialsSection() {
  return (
    <section id="temoignages" className="py-20 bg-muted/50 hidden">
        ...
        <div className="text-center mt-12">
          <div className="bg-labtek-blue/10 dark:bg-labtek-blue/20 rounded-lg p-8 max-w-4xl mx-auto">
            ...
            <button
              ...
              className="bg-white text-labtek-blue dark:text-black border-2 border-labtek-blue hover:bg-labtek-blue hover:text-white dark:hover:text-white px-8 py-3 rounded-lg font-semibold transition-all duration-200 transform hover:scale-105"
            >
