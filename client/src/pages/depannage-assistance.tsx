            ...
            <div className="space-y-6 lg:space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed text-responsive">
                  ...
                  Nous arrivons rapidement pour tout remettre en ordre.
                  Disponibles même le weekend pour les urgences !
                </p>
              </div>
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-blue-500/20 text-blue-700 dark:text-blue-300">
              Nos Services
            </Badge>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Un service complet de dépannage informatique adapté à tous vos
              besoins
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Identification précise du problème",
                color: "bg-blue-500",
              },
              {
                icon: Wrench,
                title: "Réparation sur place",
                desc: "Intervention directe chez vous",
                color: "bg-green-500",
              },
              {
                icon: HeadphonesIcon,
                title: "Assistance à distance",
                desc: "Aide immédiate par internet",
                color: "bg-purple-500",
              },
              {
                icon: Clock,
                title: "Formation incluse",
                desc: "Nous vous expliquons pour éviter la récidive",
                color: "bg-orange-500",
              },
            ].map((service, index) => (
              <Card
                ...
                <div className="grid lg:grid-cols-2 gap-0">
                  <div className="p-12">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                      Nous nous déplaçons chez vous avec tout le matériel
                      nécessaire. Diagnostic sur place, réparation immédiate si
                      possible et conseils personnalisés.
                    </p>
                    <div className="space-y-6">
                      {[
                        {
                          title: "Diagnostic complet",
                          desc: "Identification précise du problème, devis transparent",
                          icon: Eye,
                        },
                        {
                          title: "Réparation sur place",
                          desc: "Si réparable immédiatement, sinon emport en atelier",
                          icon: Wrench,
                        },
                        {
                          title: "Formation et conseils inclus",
                          desc: "Prévention et bonnes pratiques pour éviter les pannes",
                          icon: TrendingUp,
                        },
                      ].map((item, index) => (
              ...
              <CardContent className="p-0">
                <div className="grid lg:grid-cols-2 gap-0">
                  ...
                  <div className="p-12 order-1 lg:order-2">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                      Résolution rapide par internet. Nous prenons le contrôle
                      de votre écran pour diagnostiquer et résoudre de nombreux
                      problèmes sans nous déplacer.
                    </p>
                    <div className="space-y-6">
                      {[
                        {
                          title: "Aide immédiate",
                          desc: "Connexion sécurisée, résolution en temps réel",
                          icon: Zap,
                        },
                        {
                          title: "Disponible 7j/7",
                          desc: "Même le weekend pour les urgences",
                          icon: Clock,
                        },
                        {
                          title: "Installation et configuration",
                          desc: "Programmes, mises à jour, paramètres optimisés",
                          icon: Settings,
                        },
                      ].map((item, index) => (
                        <div key={index} className="flex items-start space-x-4">
              ...
              <CardContent className="p-0">
                <div className="grid lg:grid-cols-2 gap-0">
                  <div className="p-12">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                      Évitez les pannes avec un entretien régulier. Nettoyage,
                      optimisation et surveillance pour un PC toujours
                      performant.
                    </p>
                    <div className="space-y-6">
                      {[
                        {
                          ...
                          desc: "Nettoyage physique et logiciel complet",
                          icon: Clock,
                        },
                        {
                          title: "Mises à jour automatiques",
                          desc: "Windows, antivirus, pilotes toujours à jour",
                          icon: Shield,
                        },
                        {
                          title: "Surveillance et optimisation",
                          desc: "Performances optimales, prévention des pannes",
                          icon: TrendingUp,
                        },
                      ].map((item, index) => (
                        <div key={index} className="flex items-start space-x-4">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Découvrez en détail chaque étape de notre intervention. Un
              processus structuré pour résoudre efficacement tous vos problèmes
              informatiques.
            </p>
          </div>
                      ...
                      {[
                        ...
                        },
                        {
                          ...
                          items: [
                            ...
                            "Tests de stabilité et fiabilité",
                            "Vérification des températures",
                            "Calibrage des écrans",
                        ...
                        },
                        {
                          ...
                          items: [
                            ...
                            "Protection contre futures pannes",
      ...
      <section className="py-20 bg-white/30 dark:bg-gray-900/30 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Solutions rapides pour tous vos soucis informatiques
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "PC lent ou qui plante",
                desc: "Optimisation performances, nettoyage système",
                icon: HardDrive,
                color: "bg-red-500",
              },
              {
                title: "Plus d'internet ou Wi-Fi",
                desc: "Configuration réseau, diagnostic connexion",
                icon: Wifi,
                color: "bg-blue-500",
              },
              {
                title: "Virus et fenêtres popup",
                desc: "Nettoyage complet, protection renforcée",
                icon: Shield,
                color: "bg-green-500",
              },
              {
                title: "Écran noir ou bleu",
                desc: "Diagnostic matériel, réparation système",
                icon: ScreenShare,
                color: "bg-purple-500",
              },
              {
                title: "Mots de passe oubliés",
                desc: "Récupération accès Windows, emails, comptes",
                icon: KeyRound,
                color: "bg-orange-500",
              },
              {
                title: "Imprimante en panne",
                desc: "Installation pilotes, configuration réseau",
                icon: Printer,
                color: "bg-teal-500",
              },
            ].map((probleme, index) => (
              <Card
                key={index}
                className="group hover:shadow-2xl transition-all duration-500 transform hover:scale-105 border-0 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm"
              >
                <CardContent className="p-8">
                  <div
                    className={`w-16 h-16 ${probleme.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                  >
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Nous intervenons rapidement dans toute l'Essonne
            </p>
          </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Intervention dans un rayon de 30km autour
