          ...
          <div className="relative bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 dark:from-orange-950/20 dark:via-red-950/20 dark:to-pink-950/20 rounded-xl p-8 border-2 border-orange-200 dark:border-orange-800 shadow-lg">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <Card className="bg-white/80 dark:bg-gray-800/80 p-4 text-center">
                ...
                <h4 className="font-bold text-lg mb-2">PC Bureautique</h4>
                <p className="text-orange-600 dark:text-orange-400 font-medium mb-3">Entretien de base - 30€/an</p>
              ...
              <Card className="bg-white/80 dark:bg-gray-800/80 p-4 text-center border-2 border-labtek-blue">
                <div className="text-xl mb-2">🎮</div>
                <h4 className="font-bold text-lg mb-2">PC Gaming</h4>
                <p className="text-purple-600 dark:text-purple-400 font-medium mb-3">Maintenance gaming - 60€/an</p>
                <ul className="text-sm space-y-2">
                  <li className="flex items-center justify-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span>Surveillance températures GPU/CPU</span>
                  </li>
                  <li className="flex items-center justify-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span>Optimisation jeux récents</span>
                  </li>
                  <li className="flex items-center justify-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span>Support prioritaire hardware</span>
                  </li>
                </ul>
              </Card>
              ...
              <Card className="bg-white/80 dark:bg-gray-800/80 p-4 text-center">
                <div className="text-xl mb-2">🏭</div>
                <h4 className="font-bold text-lg mb-2">Workstation Pro</h4>
                <p className="text-red-600 dark:text-red-400 font-medium mb-3">Support critique - 150€/an</p>
                <ul className="text-sm space-y-2">
                  <li className="flex items-center justify-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span>Surveillance 24/7 performances</span>
                  </li>
                  <li className="flex items-center justify-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span>Tuning sécurisé CPU/GPU</span>
                  </li>
                  <li className="flex items-center justify-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span>Upgrade hardware prioritaire</span>
                  </li>
                </ul>
              </Card>
            </div>
