      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-32 container-mobile service-hero-container">
          <Button
            onClick={goBack}
            variant="ghost"
            className="mb-8 hover:bg-white/20 backdrop-blur-sm"
          >
            ...
            <div className="space-y-6 lg:space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed text-responsive">
                  ...
                  vous paraissez plus professionnel. Ça marche sur votre
                  téléphone, tablette et ordinateur automatiquement.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  ...
                  size="lg"
                  className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-600/90 hover:to-purple-600/90 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                >
                ...
                <Button
                  ...
                  className="border-2 hover:bg-white/50 backdrop-blur-sm"
                >
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-green-500/20 text-green-700 dark:text-green-300">
              Pourquoi choisir ?
            </Badge>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Votre crédibilité et votre image de marque n'ont jamais été aussi
              importantes
            </p>
          </div>
            ...
            {[
              {
                icon: Building,
                title: "Plus crédible",
                desc: "Paraissez professionnel avec votre propre domaine",
                color: "bg-green-500",
              },
              {
                icon: Globe,
                title: "Partout disponible",
                desc: "Fonctionne sur PC, smartphone et tablette",
                color: "bg-blue-500",
              },
              {
                icon: Shield,
                title: "Sécurisé",
                desc: "Protection anti-spam et sécurité renforcée",
                color: "bg-purple-500",
              },
              {
                icon: Users,
                title: "Facile à retenir",
                desc: "Vos clients se souviennent de votre nom",
                color: "bg-orange-500",
              },
            ].map((avantage, index) => (
              <Card
                key={index}
                className="group hover:shadow-2xl transition-all duration-500 transform hover:scale-105 border-0 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm hover:bg-white/80 dark:hover:bg-gray-800/80"
              >
                <CardContent className="p-8 text-center">
                  <div
                    className={`w-16 h-16 ${avantage.color} rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                  >
                ...
                <div className="grid lg:grid-cols-2 gap-0">
                  <div className="p-12">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                      Votre adresse email @votre-nom.fr configurée sur tous vos
                      appareils. Simple, efficace et professionnel.
                    </p>
                    <div className="space-y-6">
                      {[
                        {
                          title: "1 adresse email",
                          desc: "contact@votre-entreprise.fr ou prenom@nom.fr",
                          icon: Mail,
                        },
                        {
                          title: "Configuration complète",
                          desc: "PC, smartphone, tablette - tout fonctionne",
                          icon: Smartphone,
                        },
                        {
                          title: "1 TB de stockage OneDrive",
                          desc: "Largement suffisant pour un usage normal",
                          icon: Globe,
                        },
                      ].map((item, index) => (
                  ...
                  <div className="p-12 order-1 lg:order-2">
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        ...
                        <Badge className="mt-2 bg-blue-500/20 text-blue-700 dark:text-blue-300">
                          À partir de 320€/an
                        </Badge>
                      </div>
                    </div>
                    <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                      Plusieurs adresses email pour votre équipe avec calendrier
                      partagé et stockage cloud professionnel.
                    </p>
                    <div className="space-y-6">
                      {[
                        {
                          title: "5 adresses email",
                          desc: "contact@, info@, commercial@, support@...",
                          icon: Users,
                        },
                        {
                          title: "Calendrier partagé",
                          desc: "Synchronisation équipe, rendez-vous clients",
                          icon: Clock,
                        },
                        {
                          title: "1 TB par utilisateur",
                          desc: "Stockage cloud OneDrive, partage de fichiers",
                          icon: Globe,
                        },
                      ].map((item, index) => (
                        <div key={index} className="flex items-start space-x-4">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Un processus simple et complet pour que tout fonctionne
              parfaitement
            </p>
          </div>
              ...
              {[
                {
                  ...
                  subtitle:
                    "Analyse de votre activité et définition de votre image email",
                  color: "bg-blue-500",
                  content: (
                ...
                },
                {
                  ...
                  subtitle:
                    "Réservation de votre-entreprise.fr pour votre usage exclusif",
                  color: "bg-green-500",
                  content: (
                    <div className="grid md:grid-cols-3 gap-6">
                      ...
                      <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                        ...
                        <ul className="space-y-2">
                          {[
                            ".fr pour entreprises françaises",
                            ".com pour activité internationale",
                            ".org pour associations",
                            "Éviter .biz, .info peu crédibles",
                          ].map((item, index) => (
                            <li
                              key={index}
                              className="text-sm text-gray-600 dark:text-gray-300 flex items-start"
                      ...
                      <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                        ...
                        <ul className="space-y-2">
                          {[
                            "contact@votre-nom.fr",
                            "info@votre-entreprise.fr",
                            "commercial@plombier-paris.fr",
                            "cabinet@avocat-martin.fr",
                          ].map((item, index) => (
                            <li
                              key={index}
                              className="text-xs text-gray-600 dark:text-gray-300 font-mono bg-white dark:bg-gray-900 p-2 rounded border"
                            >
                              {item}
                            </li>
                          ))}
                ...
                },
                {
                  ...
                  subtitle:
                    "Paramétrage sécurisé de vos boîtes email professionnelles",
                  color: "bg-purple-500",
                  content: (
                    <div className="grid md:grid-cols-2 gap-8">
                      <div>
                ...
                },
                {
                  ...
                  subtitle:
                    "Installation et synchronisation automatique sur PC, smartphone, tablette",
                  color: "bg-orange-500",
                  content: (
                    <div className="grid md:grid-cols-3 gap-6">
                      {[
                        {
                          ...
                          icon: Laptop,
                          items: [
                            "Outlook configuré automatiquement",
                            "Thunderbird si vous préférez",
                            "Accès webmail depuis navigateur",
                        ...
                        },
                        {
                          ...
                          icon: Smartphone,
                          items: [
                            "iPhone configuré avec Mail natif",
                            "Android avec Gmail ou app native",
                        ...
                        },
                        {
                          ...
                          icon: Eye,
                          items: [
                            "iPad avec Mail natif configuré",
                            "Tablette Android configurée",
                            "Applications optimisées tablette",
                ...
                },
                {
                  ...
                  subtitle:
                    "Apprentissage complet pour maîtriser votre nouvel email professionnel",
                  color: "bg-teal-500",
                  content: (
                    <div className="grid md:grid-cols-2 gap-8">
                      <div>
                ...
                <AccordionItem
                  key={step.value}
                  value={step.value}
                  className="border-0 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  <AccordionTrigger className="hover:no-underline px-8 py-6">
                    <div className="flex items-center w-full">
                      <div
                        className={`w-12 h-12 ${step.color} rounded-xl flex items-center justify-center mr-6`}
                      >
      ...
      <section className="py-20 bg-white/30 dark:bg-gray-900/30 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Voyez la différence pour votre crédibilité
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <Button
              onClick={scrollToContact}
              size="lg"
              className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-600/90 hover:to-purple-600/90 text-white shadow-xl"
            >
